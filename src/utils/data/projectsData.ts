export const projectsData =[
  {
    ...
    texts: {
      textA: "The shoot fully immerses the subject in minimalist, soft light and a calming, cool blue aura, drawing out intense raw emotional depth and subtle nuances.",
      textB: "Through the lens, I wanted to capture not just the look, but the energy and mood.",
  ...
  {
    title: "Amara Sinclair",
    projectId: "p002",
    date: "03_2025",
    modelName: "Amara Sinclair",
    texts: {
      textA: "The shoot envelops the subject in rich, purple hues, with dramatic lighting highlighting the flowing dark dress, drawing out a powerful yet serene emotional presence.",
      textB: "I aimed to capture not just her look, but the energy she radiated.",
      textC: `"The session was a truly inspiring experience. I felt both empowered and pushed to explore new depths in my expression, especially with the bold use of purple tones and the contrast of my long dark dress. The shoot was a unique challenge, but I loved how it allowed my personality to shine through in such a dramatic yet subtle way. I'm thrilled with the final images!"`,
    },
  ...
  },
  {
    ...
    projectId: "p003",
    date: "04_2025",
    modelName: "Matteo Moreau",
    texts: {
      textA: "The shoot envelops the subject in bold urban tones, with striking lighting accentuating his sharp, street-inspired look, evoking both intensity and cool confidence.",
      textB: "I aimed to capture not just his appearance, but the unfiltered, raw energy he embodies in every move.",
